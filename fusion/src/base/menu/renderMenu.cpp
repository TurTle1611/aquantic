...
Although it looks good, it was my (deadshell's) first time making an imgui menu and it was kind of rushed to release ela.win.
...
void Menu::RenderMenu()
{
	...
	ImVec2 textSize = Menu::FontBold->CalcTextSizeA(28, FLT_MAX, 0.0f, "ela.win");
	float posX = windowPos.x + (columnWidth / 2) - (textSize.x / 2);
	float posY = windowPos.y + 20;

	Menu::GlitchText("ela.win", ImVec2(posX, posY));
